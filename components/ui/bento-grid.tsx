...
export const BentoCard = ({
  ...
  <div
    ...
    className={cn(
      ...
      "bg-zinc-900/50 [border:1px_solid_rgba(255,255,255,.08)] [box-shadow:0_-20px_80px_-20px_#a1a1aa1f_inset]",
      "transform-gpu",
      className
    )}
  >
    ...
    <div className="pointer-events-none relative z-10 flex transform-gpu flex-col gap-1 p-6 transition-all duration-300 sm:group-hover:-translate-y-10">
      <Icon className="h-12 w-12 origin-left transform-gpu text-zinc-200 transition-all duration-300 ease-in-out group-hover:scale-75" />
      ...
      {href && cta && (
        <a
          href={href}
          className="pointer-events-auto mt-2 inline-flex items-center text-sm font-medium text-zinc-200 hover:text-white sm:hidden"
        >
    ...
    {href && cta && (
      ...
      <div className="pointer-events-none absolute bottom-0 hidden w-full translate-y-10 transform-gpu flex-row items-center p-4 opacity-0 transition-all duration-300 group-hover:translate-y-0 group-hover:opacity-100 sm:flex">
        <a
          href={href}
          className="pointer-events-auto inline-flex items-center text-sm font-medium text-zinc-200 hover:text-white"
        >
          {cta} <ArrowRight className="ml-2 h-4 w-4" />
        </a>
      </div>
